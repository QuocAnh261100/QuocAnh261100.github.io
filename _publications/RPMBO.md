...
excerpt: 'This paper proposes a geometry-aware, semi-supervised method for high-dimensional Bayesian Optimization that learns a low-dimensional latent manifold via neural networks, enabling efficient optimization and outperforming existing baselines.'
date: 2024-08-22
